export const dbTables = {
  ...
  promotion_barcodes: "promotion_barcodes",
  purchases: "purchases",
...
export const tenantScopedTables = [
  ...
  dbTables.promotions,
  dbTables.promotion_items,
  dbTables.promotion_barcodes,
  dbTables.purchases,
...
export const tableDefinitions: Record<DbTableName, readonly string[]> = {
  ...
  promotion_items: ["id", "tenant_id", "promotion_id", "product_id", "quantity", "created_at", "updated_at"],
  promotion_barcodes: ["id", "tenant_id", "promotion_id", "barcode", "is_primary", "created_at", "updated_at"],
